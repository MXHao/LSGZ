...
Page({
  ...
  buy_A() { //确认购买生成订单
    var list = [{
      num: this.data.num,
      pId: this.data.details.i,
      pim: this.data.details.m,
      pn: this.data.details.n,
      pp: this.data.details.pp,
    ...
    wx.navigateTo({
      url: '/pages/ConfirmOrder/ConfirmOrder?isOn=1&type=1&data=' + encodeURIComponent(JSON.stringify(list)),
    })
  },
  showModal(e) {
    this.setData({
  ...
  onShareAppMessage() {
    return {
      ...
      path: '/pages/product-Details-On/product-Details-On?id=' + this.data.details.i + '&sou=' + this.data.details.sou,
      success(e) {
        console.log(e)
      }
    }
